...
chessjen.plot_multiple_ntc_boreholes(savepath=output_path + 'icetemp_results/' , title='Chessjengletscher 08/2024-09/2024'   , depths=[6.8,11.8,8.5,13.5]    , borehole_labels=['BH7','BH8'], lower_y_limit=-1.5, legend_loc='upper right')
...
chessjen.plot_multiple_ntc_boreholes(savepath=output_path + 'icetemp_results/' , title='Chessjengletscher 08/2024-09/2024 calibrated'   , depths=[6.8,11.8,8.5,13.5]    , borehole_labels=['BH7','BH8'], lower_y_limit=-3.5, calibrate=True, zero_deg_offsets=[zero_deg_offsets_logger7,zero_deg_offsets_logger8])
