...
sex_rouge.plot_multiple_ntc_boreholes(savepath=output_path, title='Glacier du Sex Rouge 08/2024-10/2024 calibrated', depths=[10.0,15.25,10.0,14.45], borehole_labels=['BH1','BH2'], lower_y_limit=-1.5, calibrate=True, zero_deg_offsets=[zero_deg_offsets_logger1,zero_deg_offsets_logger2])
tortin.plot_multiple_ntc_boreholes(savepath=output_path   , title='Glacier de Tortin 08/2024-09/2024 calibrated'   , depths=[4.2,9.2,8.3,13.3]     , borehole_labels=['BH3','BH4'], lower_y_limit=-1.5, calibrate=True, zero_deg_offsets=[zero_deg_offsets_logger3,zero_deg_offsets_logger4])
hohlaub.plot_multiple_ntc_boreholes(savepath=output_path  , title='Hohlaubgletscher 08/2024-09/2024 calibrated'    , depths=[10.6,15.6,10.4,15.4]  , borehole_labels=['BH5','BH6'], lower_y_limit=-1.5, calibrate=True, zero_deg_offsets=[zero_deg_offsets_logger5,zero_deg_offsets_logger6])
chessjen.plot_multiple_ntc_boreholes(savepath=output_path , title='Chessjengletscher 08/2024-09/2024 calibrated'   , depths=[6.8,11.8,8.5,13.5]    , borehole_labels=['BH7','BH8'], lower_y_limit=-3.5, calibrate=True, zero_deg_offsets=[zero_deg_offsets_logger7,zero_deg_offsets_logger8])
alphubel.plot_multiple_ntc_boreholes(savepath=output_path , title='Alphubel South 08/2024-10/2024 calibrated'      , depths=[8.0,13.0,9.0,14.0]    , borehole_labels=['BH9','BH10'], lower_y_limit=-3.5, calibrate=True, zero_deg_offsets=[zero_deg_offsets_logger9,zero_deg_offsets_logger10])
corvatsch.plot_multiple_ntc_boreholes(savepath=output_path, title='Corvatsch 08/2024-10/2024 calibrated'           , depths=[2.0,7.0,4.3,9.3]      , borehole_labels=['BH11','BH12'], lower_y_limit=-3.5, calibrate=True, zero_deg_offsets=[zero_deg_offsets_logger11,zero_deg_offsets_logger12])
